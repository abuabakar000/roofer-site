            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12">
              {detailedServices.slice(0, 6).map((service, idx) => (
                <div
                  key={service.id}
                  id={service.id}
                  className="group relative bg-[#0c0e12] border border-zinc-800/60 rounded-2xl p-6 md:p-10 hover:bg-[#0f1116] hover:-translate-y-2 hover:border-amber-500/30 hover:shadow-[0_20px_40px_-15px_rgba(132,204,22,0.15)] transition-all duration-500 ease-out flex flex-col h-full overflow-hidden"
                >
                  {/* Ambient Hover Glow */}
