...
export const metadata = {
  title: "Service Areas & Locations | Elite Roofing",
  description: "View our comprehensive roofing service areas. We provide premium residential and commercial roofing across the entire metropolitan region.",
};
